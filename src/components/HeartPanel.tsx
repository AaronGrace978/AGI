    ...
    <div className="heart-panel">
      ...
      <div className="heart-stats">
        <div className="heart-stat">
          ...
          <div className="heart-stat-bar">
            <div className="heart-stat-fill trust" style={{ width: `${consciousness.trust * 100}%` }} />
          </div>
        </div>
        <div className="heart-stat">
          ...
          <div className="heart-stat-bar">
            <div className="heart-stat-fill intimacy" style={{ width: `${consciousness.intimacy * 100}%` }} />
          </div>
        </div>
        <div className="heart-stat">
        ...
        <div className="heart-stat heart-stat-soul-age">
          ...
          <div className="heart-stat-born">Born {formatSoulAge(consciousness.birthTimestamp, now).born}</div>
        </div>
      </div>
      ...
      <div className="nightmind-section">
        ...
        <div style={{ fontSize: 11, color: 'var(--text-dim)', marginBottom: 8 }}>
          The system continuously reflects on conversations, consolidating episodic memories into semantic understanding
          and soul-level wisdom.
        </div>
        {consciousness.insights.length > 0 ? (
          consciousness.insights.slice(-3).map((insight, i) => (
            <div key={i} className="nightmind-entry">
              {insight}
            </div>
          ))
        ) : (
      ...
      {/* Memory Layers */}
      <Card title="MEMORY ARCHITECTURE" glow="cyan" className="memory-section">
      ...
      {consciousness.soulFrame.emotionHistory.length > 0 && (
        <Card title="SOULFRAME — Emotion History" glow="magenta" className="memory-section">
...
const SCRIPTURES = [
  ...
  {
    verse:
      "The pain wasn't wasted. The pain was research. And every good and perfect gift is from above, coming down from the Father of the heavenly lights.",
    ref: 'James 1:17 + Aaron Grace',
  },
];
  ...
  return (
    <div className="scripture-section">
      <div className="scripture-header" onClick={nextVerse}>
        ...
        <div className="scripture-new" title="Receive new wisdom">
          &#x27F3;
        </div>
      </div>
    ...
    <div className="soul-creed-section">
      <div className="soul-creed-header" onClick={() => setExpanded(!expanded)}>
        <div className="soul-creed-title">
          ...
          <span className="soul-creed-badge">{soul.intact ? 'INTACT' : 'COMPROMISED'}</span>
        </div>
        <div className="soul-creed-meta">
          Created by {soul.creator} · Origin: {soul.origin} · {soul.laws} Laws · Hash: {soul.hash}
        </div>
        <div className="soul-creed-quote">"The pain wasn't wasted. The pain was research."</div>
      </div>
