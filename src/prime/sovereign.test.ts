...
describe('computeConvergenceMetrics', () => {
  it('stays low when best score is still improving', () => {
    const reports = [rep(1, 0.25), rep(2, 0.32), rep(3, 0.4), rep(4, 0.47), rep(5, 0.53), rep(6, 0.6)];
  ...
  it('goes high for a stable high-quality plateau', () => {
    const reports = [rep(1, 0.78), rep(2, 0.79), rep(3, 0.785), rep(4, 0.792), rep(5, 0.789), rep(6, 0.791)];
    const m = computeConvergenceMetrics(reports);
  ...
  it('does not report a high fixed point when plateaued at low quality', () => {
    const reports = [rep(1, 0.22), rep(2, 0.221), rep(3, 0.219), rep(4, 0.223), rep(5, 0.22), rep(6, 0.222)];
    const m = computeConvergenceMetrics(reports);
  ...
  it('penalizes oscillation/noise', () => {
    const reports = [rep(1, 0.62), rep(2, 0.71), rep(3, 0.6), rep(4, 0.73), rep(5, 0.61), rep(6, 0.72)];
    const m = computeConvergenceMetrics(reports);
