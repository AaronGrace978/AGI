...
export function evolvePIESearchDefaults(params?: { seed?: number; iterations?: number }): PIEEvolutionReport {
  ...
  for (let i = 0; i < iterations; i++) {
    ...
    if (knob === 'maxExpansions')
      current.maxExpansions = clampInt(current.maxExpansions + r.int(-3000, 3000), 1000, 40000);
